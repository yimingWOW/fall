...
//     await program.methods.createLendingPool()
//     .accounts({
//       pool: values.poolKey,
//       mintA: values.mintAKeypair.publicKey,
//       mintB: values.mintBKeypair.publicKey,
...
//     try {
//       const sim = await program.methods.initLendingPool()
//         .accounts({
//           pool: values.poolKey,
//           mintA: values.mintAKeypair.publicKey,
//           mintB: values.mintBKeypair.publicKey,
...
//       const tx = await program.methods.initLendingPool()
//         .accounts({
//           pool: values.poolKey,
//           mintA: values.mintAKeypair.publicKey,
//           mintB: values.mintBKeypair.publicKey,
